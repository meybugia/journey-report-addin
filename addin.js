...
console.log('[JR] addin.js loaded, geotab=', typeof geotab, 'geotab.addin=', typeof geotab?.addin);

geotab.addin.journeyReport = () => {
  'use strict';
  ...
  function loadDevices() {
    console.log('[JR] loadDevices called, _api=', _api);
    if (!_api) { console.error('[JR] _api is null!'); return; }
    _api.call('Get', { typeName: 'Device', resultsLimit: 5000 }, devices => {
      console.log('[JR] devices loaded:', devices ? devices.length : 'null');
      ...
      console.error('[JR] loadDevices error:', err);
